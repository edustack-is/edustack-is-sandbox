...
import { CreateScheduleEventDto, CreateSubstitutionDto, SuccessResponseDto, UpdateScheduleEventDto, UpsertTimeSlotsDto , TimeSlotDto } from '../common/dto/api.dto';
import { ErrorResponseDto } from '../common/dto/error-response.dto';

import { CollisionResultDto, GenerateScheduleResultDto, RecurringEventResponseDto, ScheduleDiffResponseDto, ScheduleEventResponseDto, ScheduleMatrixResponseDto, SnapshotResponseDto, SubstitutionResponseDto } from '../common/dto/response.dto';
@ApiTags('schedule')
...
export class ScheduleController {
    ...
    @ApiResponse({ status: 200, description: 'Časové sloty (zvonění) – pole.', type: TimeSlotDto, isArray: true })
    ...
    @ApiResponse({ status: 200, description: 'Uložené časové sloty.', type: TimeSlotDto, isArray: true })
    ...
    @ApiResponse({ status: 200, description: 'Rozvrhové události – pole.', type: ScheduleEventResponseDto, isArray: true })
    @ApiResponse({ status: 401, description: 'Neautorizovaný přístup – chybí nebo neplatný JWT token.', type: ErrorResponseDto })
    @ApiResponse({ status: 403, description: 'Nedostatečná oprávnění pro tuto operaci.', type: ErrorResponseDto })
    ...
    @ApiResponse({ status: 201, description: 'Vytvořená rozvrhová událost.', type: ScheduleEventResponseDto })
    ...
    @ApiResponse({ status: 201, description: 'Hromadně vytvořené události – pole.', type: ScheduleEventResponseDto, isArray: true })
    @ApiResponse({ status: 401, description: 'Neautorizovaný přístup – chybí nebo neplatný JWT token.', type: ErrorResponseDto })
    @ApiResponse({ status: 403, description: 'Nedostatečná oprávnění pro tuto operaci.', type: ErrorResponseDto })
    @ApiResponse({ status: 400, description: 'Neplatný požadavek – chyba validace vstupních dat.', type: ErrorResponseDto })
    ...
    @ApiResponse({ status: 200, description: 'Výsledek kontroly kolizí.', type: CollisionResultDto })
    @ApiResponse({ status: 401, description: 'Neautorizovaný přístup – chybí nebo neplatný JWT token.', type: ErrorResponseDto })
    @ApiResponse({ status: 403, description: 'Nedostatečná oprávnění pro tuto operaci.', type: ErrorResponseDto })
    ...
    @ApiResponse({ status: 200, description: 'Rozvrh třídy – matice.', type: ScheduleMatrixResponseDto })
    @ApiResponse({ status: 401, description: 'Neautorizovaný přístup – chybí nebo neplatný JWT token.', type: ErrorResponseDto })
    @ApiResponse({ status: 403, description: 'Nedostatečná oprávnění pro tuto operaci.', type: ErrorResponseDto })
    @ApiResponse({ status: 404, description: 'Záznam nebyl nalezen.', type: ErrorResponseDto })
    ...
    @ApiResponse({ status: 200, description: 'Rozvrh učitele – matice.', type: ScheduleMatrixResponseDto })
    @ApiResponse({ status: 401, description: 'Neautorizovaný přístup – chybí nebo neplatný JWT token.', type: ErrorResponseDto })
    @ApiResponse({ status: 403, description: 'Nedostatečná oprávnění pro tuto operaci.', type: ErrorResponseDto })
    @ApiResponse({ status: 404, description: 'Záznam nebyl nalezen.', type: ErrorResponseDto })
    ...
    @ApiResponse({ status: 200, description: 'Suplování – pole.', type: SubstitutionResponseDto, isArray: true })
    @ApiResponse({ status: 401, description: 'Neautorizovaný přístup – chybí nebo neplatný JWT token.', type: ErrorResponseDto })
    @ApiResponse({ status: 403, description: 'Nedostatečná oprávnění pro tuto operaci.', type: ErrorResponseDto })
    ...
    @ApiResponse({ status: 201, description: 'Vytvořené suplování.', type: SubstitutionResponseDto })
    ...
    @ApiResponse({ status: 200, description: 'Aktualizované suplování.', type: SubstitutionResponseDto })
    @ApiResponse({ status: 401, description: 'Neautorizovaný přístup – chybí nebo neplatný JWT token.', type: ErrorResponseDto })
    @ApiResponse({ status: 403, description: 'Nedostatečná oprávnění pro tuto operaci.', type: ErrorResponseDto })
    @ApiResponse({ status: 400, description: 'Neplatný požadavek – chyba validace vstupních dat.', type: ErrorResponseDto })
    @ApiResponse({ status: 404, description: 'Záznam nebyl nalezen.', type: ErrorResponseDto })
    ...
    @ApiResponse({ status: 200, description: 'Výsledek generování rozvrhu.', type: GenerateScheduleResultDto })
    @ApiResponse({ status: 401, description: 'Neautorizovaný přístup – chybí nebo neplatný JWT token.', type: ErrorResponseDto })
    @ApiResponse({ status: 403, description: 'Nedostatečná oprávnění pro tuto operaci.', type: ErrorResponseDto })
    @ApiResponse({ status: 400, description: 'Neplatný požadavek – chyba validace vstupních dat.', type: ErrorResponseDto })
    ...
    @ApiResponse({ status: 200, description: 'Snapshoty rozvrhu – pole.', type: SnapshotResponseDto, isArray: true })
    @ApiResponse({ status: 401, description: 'Neautorizovaný přístup – chybí nebo neplatný JWT token.', type: ErrorResponseDto })
    @ApiResponse({ status: 403, description: 'Nedostatečná oprávnění pro tuto operaci.', type: ErrorResponseDto })
    ...
    @ApiResponse({ status: 201, description: 'Vytvořený snapshot.', type: SnapshotResponseDto })
    @ApiResponse({ status: 401, description: 'Neautorizovaný přístup – chybí nebo neplatný JWT token.', type: ErrorResponseDto })
    @ApiResponse({ status: 403, description: 'Nedostatečná oprávnění pro tuto operaci.', type: ErrorResponseDto })
    @ApiResponse({ status: 400, description: 'Neplatný požadavek – chyba validace vstupních dat.', type: ErrorResponseDto })
    @ApiResponse({ status: 404, description: 'Záznam nebyl nalezen.', type: ErrorResponseDto })
    ...
    @ApiResponse({ status: 200, description: 'Kroužky – pole.', type: RecurringEventResponseDto, isArray: true })
    @ApiResponse({ status: 401, description: 'Neautorizovaný přístup – chybí nebo neplatný JWT token.', type: ErrorResponseDto })
    @ApiResponse({ status: 403, description: 'Nedostatečná oprávnění pro tuto operaci.', type: ErrorResponseDto })
    ...
    @ApiResponse({ status: 201, description: 'Vytvořený kroužek.', type: RecurringEventResponseDto })
    @ApiResponse({ status: 401, description: 'Neautorizovaný přístup – chybí nebo neplatný JWT token.', type: ErrorResponseDto })
    @ApiResponse({ status: 403, description: 'Nedostatečná oprávnění pro tuto operaci.', type: ErrorResponseDto })
    @ApiResponse({ status: 400, description: 'Neplatný požadavek – chyba validace vstupních dat.', type: ErrorResponseDto })
    @ApiResponse({ status: 404, description: 'Záznam nebyl nalezen.', type: ErrorResponseDto })
    ...
    @ApiResponse({ status: 200, description: 'Aktualizovaný kroužek.', type: RecurringEventResponseDto })
    @ApiResponse({ status: 401, description: 'Neautorizovaný přístup – chybí nebo neplatný JWT token.', type: ErrorResponseDto })
    @ApiResponse({ status: 403, description: 'Nedostatečná oprávnění pro tuto operaci.', type: ErrorResponseDto })
    @ApiResponse({ status: 400, description: 'Neplatný požadavek – chyba validace vstupních dat.', type: ErrorResponseDto })
    @ApiResponse({ status: 404, description: 'Záznam nebyl nalezen.', type: ErrorResponseDto })
