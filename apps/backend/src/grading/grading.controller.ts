...
import { BehaviorGradeDto, CompetencyGradeDto, CreateGradeDto, GradeResponseDto, MeasureDto, PolishTextDto, SuccessResponseDto, UpdateGradeDto, UpsertReportCardDto } from '../common/dto/api.dto';
import { ErrorResponseDto } from '../common/dto/error-response.dto';

import { AiTextResponseDto, BehaviorGradeResponseDto, CommissionExamResponseDto, CompetencyGradeResponseDto, GradeHistoryEntryDto, GradingDeadlineResponseDto, GradingTypeResponseDto, MeasureResponseDto, ReportCardResponseDto } from '../common/dto/response.dto';
@ApiTags('grading')
...
export class GradingController {
    ...
    @ApiResponse({ status: 200, description: 'Známky třídy – pole objektů.', type: GradeResponseDto, isArray: true })
    @ApiResponse({ status: 401, description: 'Neautorizovaný přístup – chybí nebo neplatný JWT token.', type: ErrorResponseDto })
    @ApiResponse({ status: 403, description: 'Nedostatečná oprávnění pro tuto operaci.', type: ErrorResponseDto })
    @ApiResponse({ status: 404, description: 'Záznam nebyl nalezen.', type: ErrorResponseDto })
    ...
    @ApiResponse({ status: 200, description: 'Známky studenta – pole objektů.', type: GradeResponseDto, isArray: true })
    @ApiResponse({ status: 401, description: 'Neautorizovaný přístup – chybí nebo neplatný JWT token.', type: ErrorResponseDto })
    @ApiResponse({ status: 403, description: 'Nedostatečná oprávnění pro tuto operaci.', type: ErrorResponseDto })
    @ApiResponse({ status: 404, description: 'Záznam nebyl nalezen.', type: ErrorResponseDto })
    ...
    @ApiResponse({ status: 200, description: 'Vážený průměr studenta.', type: GradeResponseDto })
    @ApiResponse({ status: 401, description: 'Neautorizovaný přístup – chybí nebo neplatný JWT token.', type: ErrorResponseDto })
    @ApiResponse({ status: 403, description: 'Nedostatečná oprávnění pro tuto operaci.', type: ErrorResponseDto })
    @ApiResponse({ status: 404, description: 'Záznam nebyl nalezen.', type: ErrorResponseDto })
    ...
    @ApiResponse({ status: 200, description: 'Vysvědčení třídy – pole.', type: ReportCardResponseDto, isArray: true })
    @ApiResponse({ status: 401, description: 'Neautorizovaný přístup – chybí nebo neplatný JWT token.', type: ErrorResponseDto })
    @ApiResponse({ status: 403, description: 'Nedostatečná oprávnění pro tuto operaci.', type: ErrorResponseDto })
    @ApiResponse({ status: 404, description: 'Záznam nebyl nalezen.', type: ErrorResponseDto })
    ...
    @ApiResponse({ status: 200, description: 'Uložené vysvědčení.', type: ReportCardResponseDto })
    ...
    @ApiResponse({ status: 200, description: 'AI vylepšený text.', type: AiTextResponseDto })
    ...
    @ApiResponse({ status: 200, description: 'Typy hodnocení pro třídu.', type: GradingTypeResponseDto, isArray: true })
    @ApiResponse({ status: 401, description: 'Neautorizovaný přístup – chybí nebo neplatný JWT token.', type: ErrorResponseDto })
    @ApiResponse({ status: 403, description: 'Nedostatečná oprávnění pro tuto operaci.', type: ErrorResponseDto })
    @ApiResponse({ status: 404, description: 'Záznam nebyl nalezen.', type: ErrorResponseDto })
    ...
    @ApiResponse({ status: 200, description: 'Hodnocení chování – pole.', type: BehaviorGradeResponseDto, isArray: true })
    @ApiResponse({ status: 401, description: 'Neautorizovaný přístup – chybí nebo neplatný JWT token.', type: ErrorResponseDto })
    @ApiResponse({ status: 403, description: 'Nedostatečná oprávnění pro tuto operaci.', type: ErrorResponseDto })
    @ApiResponse({ status: 404, description: 'Záznam nebyl nalezen.', type: ErrorResponseDto })
    ...
    @ApiResponse({ status: 200, description: 'Uložené hodnocení kompetence.', type: CompetencyGradeResponseDto })
    ...
    @ApiResponse({ status: 200, description: 'Kompetence studenta – pole.', type: CompetencyGradeResponseDto, isArray: true })
    @ApiResponse({ status: 401, description: 'Neautorizovaný přístup – chybí nebo neplatný JWT token.', type: ErrorResponseDto })
    @ApiResponse({ status: 403, description: 'Nedostatečná oprávnění pro tuto operaci.', type: ErrorResponseDto })
    @ApiResponse({ status: 404, description: 'Záznam nebyl nalezen.', type: ErrorResponseDto })
    ...
    @ApiResponse({ status: 201, description: 'Vytvořené výchovné opatření.', type: MeasureResponseDto })
    ...
    @ApiResponse({ status: 200, description: 'Seznam opatření – pole.', type: MeasureResponseDto, isArray: true })
    @ApiResponse({ status: 401, description: 'Neautorizovaný přístup – chybí nebo neplatný JWT token.', type: ErrorResponseDto })
    @ApiResponse({ status: 403, description: 'Nedostatečná oprávnění pro tuto operaci.', type: ErrorResponseDto })
    @ApiResponse({ status: 404, description: 'Záznam nebyl nalezen.', type: ErrorResponseDto })
    ...
    @ApiResponse({ status: 200, description: 'Historie změn známek – pole.', type: GradeHistoryEntryDto, isArray: true })
    @ApiResponse({ status: 401, description: 'Neautorizovaný přístup – chybí nebo neplatný JWT token.', type: ErrorResponseDto })
    @ApiResponse({ status: 403, description: 'Nedostatečná oprávnění pro tuto operaci.', type: ErrorResponseDto })
    @ApiResponse({ status: 404, description: 'Záznam nebyl nalezen.', type: ErrorResponseDto })
    ...
    @ApiResponse({ status: 201, description: 'Vytvořené komisionální přezkoušení.', type: CommissionExamResponseDto })
    @ApiResponse({ status: 401, description: 'Neautorizovaný přístup – chybí nebo neplatný JWT token.', type: ErrorResponseDto })
    @ApiResponse({ status: 403, description: 'Nedostatečná oprávnění pro tuto operaci.', type: ErrorResponseDto })
    @ApiResponse({ status: 400, description: 'Neplatný požadavek – chyba validace vstupních dat.', type: ErrorResponseDto })
    ...
    @ApiResponse({ status: 200, description: 'Komisionální přezkoušení – pole.', type: CommissionExamResponseDto, isArray: true })
    @ApiResponse({ status: 401, description: 'Neautorizovaný přístup – chybí nebo neplatný JWT token.', type: ErrorResponseDto })
    @ApiResponse({ status: 403, description: 'Nedostatečná oprávnění pro tuto operaci.', type: ErrorResponseDto })
    @ApiResponse({ status: 404, description: 'Záznam nebyl nalezen.', type: ErrorResponseDto })
    ...
    @ApiResponse({ status: 200, description: 'Aktualizované přezkoušení.', type: CommissionExamResponseDto })
    @ApiResponse({ status: 401, description: 'Neautorizovaný přístup – chybí nebo neplatný JWT token.', type: ErrorResponseDto })
    @ApiResponse({ status: 403, description: 'Nedostatečná oprávnění pro tuto operaci.', type: ErrorResponseDto })
    @ApiResponse({ status: 400, description: 'Neplatný požadavek – chyba validace vstupních dat.', type: ErrorResponseDto })
    @ApiResponse({ status: 404, description: 'Záznam nebyl nalezen.', type: ErrorResponseDto })
    ...
    @ApiResponse({ status: 200, description: 'Přezkoušení smazáno.', type: SuccessResponseDto })
    @ApiResponse({ status: 401, description: 'Neautorizovaný přístup – chybí nebo neplatný JWT token.', type: ErrorResponseDto })
    @ApiResponse({ status: 403, description: 'Nedostatečná oprávnění pro tuto operaci.', type: ErrorResponseDto })
    @ApiResponse({ status: 404, description: 'Záznam nebyl nalezen.', type: ErrorResponseDto })
