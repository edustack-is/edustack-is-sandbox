...
const RESPONSES = {
    'auth/auth.controller.ts': {
        getSsoOptions: { s: 200, d: 'Seznam SSO poskytovatelů.', t: 'SsoOptionDto', arr: true },
        ssoAuth: { s: 302, d: 'Přesměrování na SSO poskytovatele.' },
        ssoCallback: { s: 302, d: 'Přesměrování s SSO tokenem.' },
        exchangeSsoToken: { s: 200, d: 'JWT token po SSO přihlášení.', t: 'LoginResponseDto' },
        inviteUser: { s: 201, d: 'Pozvánka odeslána.', t: 'SuccessResponseDto' },
        acceptInvite: { s: 200, d: 'Účet aktivován.', t: 'SuccessResponseDto' },
        forgotPassword: { s: 200, d: 'E-mail s odkazem odeslán.', t: 'SuccessResponseDto' },
        resetPassword: { s: 200, d: 'Heslo změněno.', t: 'SuccessResponseDto' },
        getIdentities: { s: 200, d: 'Seznam propojených SSO identit.' },
        impersonate: { s: 200, d: 'JWT token impersonovaného uživatele.', t: 'LoginResponseDto' },
        login: { s: 200, d: 'Přihlášení úspěšné.', t: 'LoginResponseDto' },
        getSchools: { s: 200, d: 'Školy uživatele.', t: 'SchoolListItemDto', arr: true },
        selectSchool: { s: 200, d: 'Tenant token pro vybranou školu.', t: 'SelectSchoolResponseDto' },
        refreshGlobal: { s: 200, d: 'Nový globální JWT token.', t: 'LoginResponseDto' },
    ...
    'grading/grading.controller.ts': {
        ...
        deleteCommissionExam: { s: 200, d: 'Přezkoušení smazáno.', t: 'SuccessResponseDto' },
    ...
    'schedule/schedule.controller.ts': {
        ...
        deleteSubstitution: { s: 200, d: 'Suplování smazáno.', t: 'SuccessResponseDto' },
        ...
        deleteRecurringEvent: { s: 200, d: 'Kroužek smazán.', t: 'SuccessResponseDto' },
    },
    'attendance/attendance.controller.ts': {
        recordAttendance: { s: 201, d: 'Docházka zaznamenána.', t: 'SuccessResponseDto' },
        ...
        getUnexcusedAlerts: { s: 200, d: 'Upozornění na neomluvené hodiny – pole.' },
    },
    'messaging/messaging.controller.ts': {
        ...
        toggleEmailNotifications: { s: 200, d: 'Stav e-mail notifikací.', t: 'ToggleResponseDto' },
    },
    'community/community.controller.ts': {
        ...
        deleteBulletinPost: { s: 200, d: 'Příspěvek smazán.', t: 'SuccessResponseDto' },
        ...
        deleteCalendarEvent: { s: 200, d: 'Událost smazána.', t: 'SuccessResponseDto' },
    },
    ...
    'deputy/deputy.controller.ts': {
        ...
        reinviteUser: { s: 200, d: 'Pozvánka znovu odeslána.', t: 'SuccessResponseDto' },
        ...
        suspendUser: { s: 200, d: 'Uživatel suspendován.', t: 'SuccessResponseDto' },
        reactivateUser: { s: 200, d: 'Uživatel reaktivován.', t: 'SuccessResponseDto' },
    },
    'deputy/deputy-curriculum.controller.ts': {
        ...
        deleteCurriculumVersion: { s: 200, d: 'Verze smazána.', t: 'SuccessResponseDto' },
        duplicateCurriculumVersion: { s: 201, d: 'Duplikovaná verze ŠVP.' },
        saveCurriculumEntry: { s: 200, d: 'Záznam ŠVP uložen.' },
        deleteCurriculumEntry: { s: 200, d: 'Záznam smazán.', t: 'SuccessResponseDto' },
        getCompetencies: { s: 200, d: 'Kompetence – pole.' },
        getCompetencyMatrix: { s: 200, d: 'Matice kompetencí.' },
        toggleCompetencyMapping: { s: 200, d: 'Mapování přepnuto.', t: 'SuccessResponseDto' },
        ...
        deleteTeachingMaterial: { s: 200, d: 'Materiál smazán.', t: 'SuccessResponseDto' },
        ...
        deleteLessonPlan: { s: 200, d: 'Příprava smazána.', t: 'SuccessResponseDto' },
    ...
    'student/student.controller.ts': {
        getMyData: { s: 200, d: 'Data studenta – profil, známky, rozvrh, docházka.' },
        getSchedule: { s: 200, d: 'Rozvrh studenta – matice.' },
    },
    'parent/parent.controller.ts': {
        getChildren: { s: 200, d: 'Děti rodiče – pole.' },
        getChildDashboard: { s: 200, d: 'Dashboard dítěte – profil, známky, rozvrh.' },
    },
    ...
    'system-admin/system-admin.controller.ts': {
        getDashboard: { s: 200, d: 'Dashboard – počty škol, uživatelů, prostředků.' },
        getSchools: { s: 200, d: 'Všechny školy – pole.' },
        createSchool: { s: 201, d: 'Vytvořená škola.' },
        updateSchool: { s: 200, d: 'Aktualizovaná škola.' },
        softDeleteSchool: { s: 200, d: 'Škola deaktivována.', t: 'SuccessResponseDto' },
    ...
    'system-admin/test-data.controller.ts': {
        generateTestData: { s: 201, d: 'Testovací data vygenerována.', t: 'SuccessResponseDto' },
        generateAll: { s: 201, d: 'Kompletní testovací sada vytvořena.', t: 'SuccessResponseDto' },
    },
    'ai/ai.controller.ts': {
    ...
    'gdpr/gdpr.controller.ts': {
        ...
        deleteMyData: { s: 200, d: 'Osobní data anonymizována.', t: 'SuccessResponseDto' },
    },
...
const VALID_TYPES = new Set([
    'LoginResponseDto', 'SsoOptionDto', 'SchoolListItemDto', 'SelectSchoolResponseDto',
    'UserProfileDto', 'GradeResponseDto', 'SuccessResponseDto', 'CountResponseDto',
    'ToggleResponseDto', 'ErrorResponseDto',
]);
...
for (const [relPath, methods] of Object.entries(RESPONSES)) {
    ...
    const needsSuccess = Object.values(methods).some(r => r && r.t === 'SuccessResponseDto');
    if (needsSuccess && !content.includes('SuccessResponseDto')) {
        if (content.includes("from '../common/dto/api.dto'")) {
            content = content.replace(
                ...
                (m, imp) => `import {${imp}, SuccessResponseDto } from '../common/dto/api.dto'`
            );
        } else {
            // Add a new import
            ...
            content = content.slice(0, end + 1) + "import { SuccessResponseDto } from '../common/dto/api.dto';\n" + content.slice(end + 1);
        }
        fileModified = true;
    }
    ...
    for (const [methodName, resp] of Object.entries(methods)) {
        ...
        const successCheck = new RegExp(`@ApiResponse\\(\\{\\s*status:\\s*${resp.s}[^}]*description:`);
        // Find @ApiOperation for this method
        const opRegex = new RegExp(`(@ApiOperation\\([^)]+\\))[\\s\\S]{0,500}?async\\s+${methodName}\\b`);
        const opMatch = opRegex.exec(content);
        if (!opMatch) continue;

        // Check in the area between @ApiOperation and async for existing success response
        const area = content.slice(opMatch.index, opMatch.index + opMatch[0].length);
        if (area.includes(`status: ${resp.s},`) && area.includes('description:')) continue;
        ...
        content = content.slice(0, opEnd) + `\n${indent}${respDecorator}` + content.slice(opEnd);
        totalAdded++;
        fileModified = true;
    }
    ...
    if (fileModified) {
        ...
        console.log(`✅ ${relPath}: ${Object.keys(methods).filter(m => methods[m]).length}`);
    }
}
